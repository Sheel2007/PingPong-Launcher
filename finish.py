    ...
    while True:
        ...
        if msgs is not None:
            ...
            for detection in detections:
                ...
                if label == 'person':
                    x, y, z = detection.spatialCoordinates.x/1000, detection.spatialCoordinates.y/1000, abs(detection.spatialCoordinates.z/1000)

                    r, theta = coordinates.cartesian_to_polar(x, y)

                    print('Before', r, theta)


                    r, theta = coordinates.reference_angle(r), coordinates.reference_angle(theta)

                    print('After', r, theta)
                    
                    motorcontrol.shoot(r, 0)
